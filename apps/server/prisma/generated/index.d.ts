...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "chat" | "chat_History"
    ...
    model: {
      ...
      Chat_History: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.Chat_HistoryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.Chat_HistoryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type ChatCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    Chat_History?: boolean | ChatCountOutputTypeCountChat_HistoryArgs
  }
   ...
   * ChatCountOutputType without action
   */
  export type ChatCountOutputTypeCountChat_HistoryArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
  ...
  export interface Prisma__ChatClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    Chat_History<T extends Chat$Chat_HistoryArgs<ExtArgs> = {}>(args?: Subset<T, Chat$Chat_HistoryArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$Chat_HistoryPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  export type Chat_HistoryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "chatId" | "message" | "role" | "createdAt", ExtArgs["result"]["chat_History"]>
  ...
  export interface Chat_HistoryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Chat_Histories that matches the filter.
     * @param {Chat_HistoryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const chat_History = await prisma.chat_History.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: Chat_HistoryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Chat_History.
     * @param {Chat_HistoryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const chat_History = await prisma.chat_History.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: Chat_HistoryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface Chat_HistoryFieldRefs {
    ...
    readonly chatId: FieldRef<"Chat_History", 'String'>
    readonly message: FieldRef<"Chat_History", 'String'>
    readonly role: FieldRef<"Chat_History", 'Role'>
    readonly createdAt: FieldRef<"Chat_History", 'DateTime'>
  }
  ...
  /**
   * Chat_History findRaw
   */
  export type Chat_HistoryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Chat_History aggregateRaw
   */
  export type Chat_HistoryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type Chat_HistoryWhereInput = {
    ...
    chatId?: StringFilter<"Chat_History"> | string
    message?: StringFilter<"Chat_History"> | string
    role?: EnumRoleFilter<"Chat_History"> | $Enums.Role
    createdAt?: DateTimeFilter<"Chat_History"> | Date | string
  ...
  export type Chat_HistoryScalarWhereWithAggregatesInput = {
    ...
    chatId?: StringWithAggregatesFilter<"Chat_History"> | string
    message?: StringWithAggregatesFilter<"Chat_History"> | string
    role?: EnumRoleWithAggregatesFilter<"Chat_History"> | $Enums.Role
    createdAt?: DateTimeWithAggregatesFilter<"Chat_History"> | Date | string
  }
  ...
  export type ChatCreateInput = {
    ...
    Chat_History?: Chat_HistoryCreateNestedManyWithoutChatInput
  }
  ...
  export type ChatUncheckedCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    Chat_History?: Chat_HistoryUncheckedCreateNestedManyWithoutChatInput
  }
  ...
  export type ChatUpdateInput = {
    ...
    Chat_History?: Chat_HistoryUpdateManyWithoutChatNestedInput
  }
  ...
  export type ChatUncheckedUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    Chat_History?: Chat_HistoryUncheckedUpdateManyWithoutChatNestedInput
  }
  ...
  export type Chat_HistoryCreateNestedManyWithoutChatInput = {
    create?: XOR<Chat_HistoryCreateWithoutChatInput, Chat_HistoryUncheckedCreateWithoutChatInput> | Chat_HistoryCreateWithoutChatInput[] | Chat_HistoryUncheckedCreateWithoutChatInput[]
    connectOrCreate?: Chat_HistoryCreateOrConnectWithoutChatInput | Chat_HistoryCreateOrConnectWithoutChatInput[]
    createMany?: Chat_HistoryCreateManyChatInputEnvelope
    connect?: Chat_HistoryWhereUniqueInput | Chat_HistoryWhereUniqueInput[]
  }

  export type Chat_HistoryUncheckedCreateNestedManyWithoutChatInput = {
    create?: XOR<Chat_HistoryCreateWithoutChatInput, Chat_HistoryUncheckedCreateWithoutChatInput> | Chat_HistoryCreateWithoutChatInput[] | Chat_HistoryUncheckedCreateWithoutChatInput[]
    connectOrCreate?: Chat_HistoryCreateOrConnectWithoutChatInput | Chat_HistoryCreateOrConnectWithoutChatInput[]
    createMany?: Chat_HistoryCreateManyChatInputEnvelope
    connect?: Chat_HistoryWhereUniqueInput | Chat_HistoryWhereUniqueInput[]
  ...
  export type Chat_HistoryUpdateManyWithoutChatNestedInput = {
    create?: XOR<Chat_HistoryCreateWithoutChatInput, Chat_HistoryUncheckedCreateWithoutChatInput> | Chat_HistoryCreateWithoutChatInput[] | Chat_HistoryUncheckedCreateWithoutChatInput[]
    connectOrCreate?: Chat_HistoryCreateOrConnectWithoutChatInput | Chat_HistoryCreateOrConnectWithoutChatInput[]
    upsert?: Chat_HistoryUpsertWithWhereUniqueWithoutChatInput | Chat_HistoryUpsertWithWhereUniqueWithoutChatInput[]
    createMany?: Chat_HistoryCreateManyChatInputEnvelope
    ...
    connect?: Chat_HistoryWhereUniqueInput | Chat_HistoryWhereUniqueInput[]
    update?: Chat_HistoryUpdateWithWhereUniqueWithoutChatInput | Chat_HistoryUpdateWithWhereUniqueWithoutChatInput[]
    updateMany?: Chat_HistoryUpdateManyWithWhereWithoutChatInput | Chat_HistoryUpdateManyWithWhereWithoutChatInput[]
    deleteMany?: Chat_HistoryScalarWhereInput | Chat_HistoryScalarWhereInput[]
  }

  export type Chat_HistoryUncheckedUpdateManyWithoutChatNestedInput = {
    create?: XOR<Chat_HistoryCreateWithoutChatInput, Chat_HistoryUncheckedCreateWithoutChatInput> | Chat_HistoryCreateWithoutChatInput[] | Chat_HistoryUncheckedCreateWithoutChatInput[]
    connectOrCreate?: Chat_HistoryCreateOrConnectWithoutChatInput | Chat_HistoryCreateOrConnectWithoutChatInput[]
    upsert?: Chat_HistoryUpsertWithWhereUniqueWithoutChatInput | Chat_HistoryUpsertWithWhereUniqueWithoutChatInput[]
    createMany?: Chat_HistoryCreateManyChatInputEnvelope
  ...
  export type Chat_HistoryCreateManyChatInputEnvelope = {
    data: Chat_HistoryCreateManyChatInput | Chat_HistoryCreateManyChatInput[]
  }
  ...
  export type Chat_HistoryUpsertWithWhereUniqueWithoutChatInput = {
    where: Chat_HistoryWhereUniqueInput
    update: XOR<Chat_HistoryUpdateWithoutChatInput, Chat_HistoryUncheckedUpdateWithoutChatInput>
    create: XOR<Chat_HistoryCreateWithoutChatInput, Chat_HistoryUncheckedCreateWithoutChatInput>
  }

  export type Chat_HistoryUpdateWithWhereUniqueWithoutChatInput = {
    where: Chat_HistoryWhereUniqueInput
    data: XOR<Chat_HistoryUpdateWithoutChatInput, Chat_HistoryUncheckedUpdateWithoutChatInput>
  }

  export type Chat_HistoryUpdateManyWithWhereWithoutChatInput = {
    where: Chat_HistoryScalarWhereInput
    data: XOR<Chat_HistoryUpdateManyMutationInput, Chat_HistoryUncheckedUpdateManyWithoutChatInput>
  }
  ...
  export type Chat_HistoryCreateManyChatInput = {
    id?: string
    message: string
    role: $Enums.Role
    createdAt?: Date | string
  ...
  export type Chat_HistoryUncheckedUpdateManyWithoutChatInput = {
    message?: StringFieldUpdateOperationsInput | string
    role?: EnumRoleFieldUpdateOperationsInput | $Enums.Role
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
